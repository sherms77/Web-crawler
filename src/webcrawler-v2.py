...
def crawler(max): # max pages paramater sets how many pages to crawl
    page = 1 # Count initializer
    
    # While loop to crawl pages based on argument passed to page paramater.
    while page <= max: # while value in page is less than max pages execute loop
        
        # url to crawl. Value from page counter converted to string and added to end of the url to specify page number on site to be crawled.
        url = 'https://www.gumtree.com.au/s-clothing-jewellery/sneakers/k0c18308' + str(page) 
        ...
        # 080122: NEED TO UPDATE CODE HERE TO MATCH NEW URL
